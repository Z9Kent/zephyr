...
/** @addtogroup ST25Tags_ST25DV_PWM
 *  @{
 */

/** @addtogroup ST25Tags_Demo
 * @{
 */
                    ...
                    case RFAL_NFC_LISTEN_TYPE_NFCV:
                        {
                            ...
                            while ( rfalNfcvPollerReadSingleBlock( RFAL_NFCV_REQ_FLAG_DEFAULT, nfcDevice->nfcid, 0, rxBuf, sizeof(rxBuf), &rcvLen ) == RFAL_ERR_NONE)
                            {
                                platformDelay(130);
                            }
...
static void demoSt25DvPwm( rfalNfcvListenDevice *nfcvDev )
{
    ...
    */
    ...
    platformLog( " Read Block %d: %s %s\r\n\r\n", blockNum, (errCode != RFAL_ERR_NONE) ? "FAIL": "OK - Data = ", (errCode != RFAL_ERR_NONE) ? "" : hex2Str( &rxBuf[1], DEMO_NFCV_BLOCK_LEN) );
