/**
  @page ST25TAGS_St25DvPwm Readme file
  
  @verbatim
  ******************** (C) COPYRIGHT 2020 STMicroelectronics *******************
  * @file    readme.txt 
  * @author  MMY Ecosystem Application Team
  * @version v1.0.0
  * @date    15-April-2020   
  * @brief   This application shows typical example use of the ST25TAGS ST25DV-PWM's API
  ******************************************************************************
  *
  *
...
This directory contains a set of source files that implement a simple example based on ST25R3916B
