...
#define RFAL_FEATURE_NFC_RF_BUF_LEN           4098U       /*!< RF buffer length used by RFAL NFC layer                                   */

#define RFAL_FEATURE_ISO_DEP_APDU_MAX_LEN     4098U       /*!< ISO-DEP APDU max length. Please use multiples of I-Block max length       */
